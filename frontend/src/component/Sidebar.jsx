                ...
                <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    <div className={cn(
                        ...
                        <Link
                            ...
                            to="https://rishabh-portfolio-rishabhs-projects-340996ab.vercel.app/#contact"
                        >
                            ...
                            <div className=" relative h-full flex flex-col">
                                ...
                                <div className={sidebarStyles.mobileFooter}>
                                    <Link onClick={() => setMobileOpen(false)}
                                        to="https://rishabh-portfolio-rishabhs-projects-340996ab.vercel.app/#contact" className={sidebarStyles.mobileFooterLink}
                                    >
                                        <HelpCircle size={20} className="text-gray-500" />
                                        <span>Support</span>
                                    </Link>
