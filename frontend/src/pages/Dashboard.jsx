...
import { GAUGE_COLORS, COLORS, INCOME_CATEGORY_ICONS, EXPENSE_CATEGORY_ICONS } from '../assets/colors'
import GaugeCard from '../component/GaugeCard'
import FinancialCard from '../component/FinancialCard'
import { ResponsiveContainer, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend } from 'recharts'
import { getTimeFrameRange, getPreviousTimeFrameRange, calculateData } from '../component/Helpers'
...
const Dashboard = () => {
    ...
    //build server-provided recent lists
    ...
    const handleAddTransaction = async () => {
        ...
        try {
            ...
            console.log("Failed to add Transaction:", error?.response || error.message || error);
        } finally {
            setLoading(false);
        }
    };
